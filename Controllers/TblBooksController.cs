...
namespace LibraryMSMVC.Controllers
{
    public class TblBooksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookId,BookTitle,BookCategory,BookAuthor,BookCopies,BookPub,BookPubName,BookISBN,Copyright,DateAdded,penaltyCharge,ReturnDaysLimit,Status")] tblBook tblBook)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookId,BookTitle,BookCategory,BookAuthor,BookCopies,BookPub,BookPubName,BookISBN,Copyright,DateAdded,penaltyCharge,ReturnDaysLimit,Status")] tblBook tblBook)
        {
            if (ModelState.IsValid)
            {
